...
Edge = (function() {
  ...
  Edge.prototype.remove = function() {
    ...
    return this.r.animate({
      ...
      _this.r.remove();
      new_edges = [];
      _ref = _this.nodea.edges;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        edge = _ref[_i];
        if (edge.n.id !== _this.nodeb.id) new_edges.push(edge);
      }
      _this.nodea.edges = new_edges;
      new_edges = [];
      _ref2 = _this.nodeb.edges;
      for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
        edge = _ref2[_j];
        if (edge.n.id !== _this.nodea.id) new_edges.push(edge);
      }
      _this.nodeb.edges = new_edges;
      new_edges = [];
      _ref3 = APP.graph.edges;
      for (_k = 0, _len3 = _ref3.length; _k < _len3; _k++) {
        edge = _ref3[_k];
        if (edge.nodea.id !== _this.nodea.id || edge.nodeb.id !== _this.nodeb.id) {
          new_edges.push(edge);
        }
      }
  ...
  Edge.prototype.click = function(e) {
    var _this = this;
    if (APP.context) APP.context.destroy();
