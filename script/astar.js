...
AStar = (function() {
  ...
  AStar.prototype._search = function() {
    ...
    while (openList.length !== 0) {
      ...
      if (currentNode === this.goal_node) break;
  ...
  AStar.prototype.getSmallestElement = function(a) {
    ...
    for (_i = 0, _len = a.length; _i < _len; _i++) {
      node = a[_i];
      if (smallNode.estimatedTotalCost > node.estimatedTotalCost) smallNode = node;
    }
    return smallNode;
  };
  ...
  AStar.prototype.create_traverse_info = function() {
    var current_node, edge, exp_nodes, fork, found, node, _i, _len, _ref, _results;
    this.traverse_info = [];
    fork = [];
