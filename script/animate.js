...
Animate = (function() {
    ...
    if ((this.algorithm.traverse_info != null) && this.pointer < this.algorithm.traverse_info.length) {
      ...
      if (current_item instanceof Node) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          edge = _ref[_i];
          if (edge.e.style === "normal") edge.e.update_style("potential");
        }
      }
      if (this.pointer !== 0) {
  ...
  Animate.prototype.step_backward = function() {
    ...
    if ((this.algorithm.traverse_info != null) && this.pointer > 0) {
      ...
      if (current_item instanceof Node) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          edge = _ref[_i];
          if (edge.e.style === "potential") edge.e.update_style("normal");
        }
      }
      if (this.pointer !== 0) {
        previous_item = this.traverse_info[this.pointer - 1];
        ...
        if (previous_item instanceof Node) {
          ...
          for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
            edge = _ref2[_j];
            if (edge.e.style !== "visited") {
              if (edge.e.style === "path") {} else {
                _results.push(edge.e.update_style("potential"));
              }
            } else {
  ...
  Animate.prototype.create_path = function(pointer) {
    ...
    for (_i = 0, _len = path.length; _i < _len; _i++) {
      edge = path[_i];
      if (edge.style !== "potential") {
        _results.push(edge.update_style("path"));
      } else {
        _results.push(void 0);
      }
    }
  ...
  Animate.prototype.reset_path = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      edge = _ref[_i];
      if (edge.style === "path") {
        _results.push(edge.update_style("visited"));
      } else {
        _results.push(void 0);
      }
    }
  ...
  Animate.prototype.traverse = function() {
    ...
    if (this.algorithm.traverse_info != null) {
      doTraverse = function() {
        _this.step_forward();
        if (_this.pointer < _this.algorithm.traverse_info.length && !_this._stop) {
